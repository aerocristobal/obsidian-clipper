var ReadabilityKit = (() => {
  ...
  var createRecord = (type, target, element, addedNodes, removedNodes, attributeName, oldValue) => ({
    ...
    attributeName,
    oldValue,
    previousSibling: (element == null ? void 0 : element.previousSibling) || null,
    nextSibling: (element == null ? void 0 : element.nextSibling) || null
  });
  ...
  var HTMLSlotElement = class extends HTMLElement {
    ...
    assignedNodes(options) {
      ...
      const hostChildNodes = (_b = (_a3 = this.getRootNode().host) == null ? void 0 : _a3.childNodes) != null ? _b : [];
      let slottables;
      if (isNamedSlot) {
  ...
  var HTMLDocument = class extends Document2 {
    ...
    get title() {
      var _a3;
      const { head } = this;
      return ((_a3 = head.getElementsByTagName("title").at(0)) == null ? void 0 : _a3.textContent) || "";
    }
